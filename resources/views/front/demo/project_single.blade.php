...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumb_wrapper d-flex align-items-center justify-content-between flex-wrap">
                        <h4 class="page_title">{{ $project->name_en }}</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('demo.index') }}">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">{{ $project->name_en }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <ul class="d-flex justify-content-center">
                                    ...
                                    @foreach ($project->projectGallery as $item)
                                        <li><a href=""><img width="100" height="70"
                                                    src="{{ asset('storage/' . $item->images) }}" alt=""></a></li>
                                    @endforeach
    ...
    <section class="related-products m-bottom-80 p-top-20">
        ...
        <div class="container">
            <div class="row">
                @foreach ($randomProjects as $item)
                    <div class="col-lg-3 col-sm-6">
                        <div class="card card-product">
                            ...
                            <div class="card-body">
                                <h6><a href="{{ route('demo.projectSingle', $item->id) }}">{{ $item->name_en }}</a></h6>
                            </div>
                        </div><!-- End: .card -->
                    </div><!-- ends: .col-lg-3 -->
                @endforeach
