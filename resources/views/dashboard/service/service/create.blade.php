                                    ...
                                    <div class="col-10">
                                        ...
                                        <div class=" row">
                                            ...
                                            <div class="mb-3 col ">
                                                ...
                                                <select id="select-service-group" name="service_group_id"
                                                    class="form-control">
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 col">
                                                                <label for="meta_title_ar"
                                                                    class="form-label required">Meta
                                                                    title
                                                                    (AR)</label>
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 col">
                                                                <label for="slug"
                                                                    class="form-label required">slug</label>
...
@section('js')
    ...
    <script>
        new TomSelect("#select-service-group", {
            sortField: {
                field: "text",
                direction: "asc"
            }
