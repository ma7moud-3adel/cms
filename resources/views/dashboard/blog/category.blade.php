                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter text-nowrap datatable text-center" id="data-table">
                                <thead>
                                    <tr>
                                        {{-- <th class="w-1">
                                        ...
                                        <th>
                                            {{ trans('main.sec_title_en') }}
                                        </th>
                                        <th>
                                            {{ trans('main.sec_title_ar') }}
                                        </th>
                                        <th></th>
                                    </tr>
                                </thead>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a class="btn btn-outline-primary"
                                                    href="{{ route('sections.edit', $item->id) }}" role="button">
                                                    {{ trans('main.Edit') }}</a>
