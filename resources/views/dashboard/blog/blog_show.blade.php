                ...
                <div class="col-12">
                    <div class="card card-md">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="empty">
                                    <div class="empty-img"><img src="{{ asset('storage/' . $blog->image) }}"
                                                                height="180"
                                                                alt="">
                                    </div>
                                    <p class="empty-title">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="markdown text-secondary col">
                                                    ...
                                                    <input type="hidden" name="blog_id" class="form-control"
                                                           value="{{ $blog->id }}" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ trans('main.comments_table_belongs') }}</h3>
                        </div>
                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable text-center">
                                ...
                                @foreach ($blog->comments as $item)
                                    <tr>
                                        ...
                                        <td><span class="text-secondary">{{ $id++ }}</span>
                                        </td>
