                ...
                <div class="col-12">
                    <div class="card card-md">
                        ...
                        <div class="card-header">
                            <h3 class="h1">{{ trans('main.add_section') }}</h3>
                        </div>
                                    ...
                                    <div class="col-10">
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="markdown text-secondary col-12 mt-3">
                                                ...
                                                <textarea id="text_area_2" name="description_ar" class="form-control" placeholder="ادخل وصف الخبر" autocomplete="off">{{ old('description_ar') }}</textarea>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="row mt-5">
                                                                <div class="markdown text-secondary col">
                                                                    ...
                                                                    <textarea name="meta_description_en" class="form-control" placeholder="Enter Blog Description" autocomplete="off"></textarea>
                                                                </div>
                                                                <div class="markdown text-secondary col">
                                                                    <label
                                                                        class="form-label">{{ trans('main.blog_meta_desc_ar') }}</label>
                                                                    <textarea name="meta_description_ar" class="form-control" placeholder="ادخل وصف الخبر" autocomplete="off"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="row mt-5">
                                                                <div class="markdown text-secondary col">
                                                            ...
                                                            <div class="row mt-5">
                                                                <div class="markdown text-secondary col">
                                                                    ...
                                                                    <textarea name="slug" class="form-control" placeholder="Enter Blog Description" autocomplete="off"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
