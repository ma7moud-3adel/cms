                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ trans('main.blog_table') }}</h3>
                        ...
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter text-nowrap datatable text-center" id="blog-table">
                                <thead>
                                    <tr>
                                        {{-- <th class="w-1">
                                        ...
                                        <th>
                                            {{ trans('main.blog_name_en') }}
                                        </th>
                                        <th>
                                            {{ trans('main.blog_name_ar') }}
                                        </th>
                                        <th>{{ trans('main.blog_image') }}</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {{-- @foreach ($blogs as $item)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a class="btn btn-outline-info" href="{{ route('blogs.show', $item->id) }}"
                                                    role="button">
                                                    {{ trans('main.Show') }}</a>
                                                <a class="btn btn-outline-primary"
                                                    href="{{ route('blogs.edit', $item->id) }}" role="button">
                                                    {{ trans('main.Edit') }}</a>
