    ...
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item d-none d-md-flex me-3">
                <div class="btn-list">
                    <a href="{{ url('/') }}" class="btn" target="_blank" rel="noreferrer">
                    ...
                    @if (app()->getLocale() == 'en')
                        <a href="{{ url('/dashboard/change-lang/ar') }}" class="btn" rel="noreferrer">
                    ...
                    @else
                        <a href="{{ url('/dashboard/change-lang/en') }}" class="btn" rel="noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-a-b-2">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
{{--                        style="background-image: url({{ auth()->user()->photo ? asset('storage/' . auth()->user()->photo) : asset('dashboard/img/000m.jpg') }})">--}}
{{--                    </span>--}}
...
{{--                    <a href="{{ route('admin.edit', auth()->user()->id) }}" class="dropdown-item">Profile</a>--}}
