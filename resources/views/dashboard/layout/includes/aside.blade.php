<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href="{{ url('/') }}">
                <img src="{{ url('dashboard/img') }}/logo.png" width="110" height="32" alt="Tabler"
...
{{--                <li class="nav-item">--}}
{{--                    <a class="nav-link" href="{{ route('course-category.index') }}">--}}
{{--                        <span--}}
{{--                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->--}}
...
{{--                </li>--}}
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('service-group.index') }}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('project_categories.index') }}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
{{--                <li class="nav-item">--}}
{{--                    <a class="nav-link" href="{{ route('clientCategory.index') }}">--}}
{{--                        <span class="nav-link-icon d-md-none d-lg-inline-block">--}}
{{--                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"--}}
{{--                                fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">--}}
{{--                                <path--}}
...
{{--                </li>--}}
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('gallary.index') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
{{--                <li class="nav-item">--}}
{{--                    <a class="nav-link" href="{{ route('government.index') }}">--}}
{{--                        <span--}}
{{--                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->--}}
{{--                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"--}}
                    ...
                    <a class="nav-link" href="{{ route('settings.index') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <path
                                    d="M8 0a1 1 0 0 1 1 1v1.072a5.992 5.992 0 0 1 1.338.622l.725-.725a1 1 0 0 1 1.415 1.415l-.725.725a5.992 5.992 0 0 1 .622 1.338H15a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-1.072a5.992 5.992 0 0 1-.622 1.338l.725.725a1 1 0 0 1-1.415 1.415l-.725-.725a5.992 5.992 0 0 1-1.338.622V15a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-1.072a5.992 5.992 0 0 1-.622-1.338l-.725.725a1 1 0 0 1-1.415-1.415l.725-.725a5.992 5.992 0 0 1-.622-1.338H1a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1h1.072a5.992 5.992 0 0 1 .622-1.338l-.725-.725A1 1 0 0 1 1.415.725l.725-.725A5.992 5.992 0 0 1 3.072 1H1a1 1 0 0 1-1-1V1a1 1 0 0 1 1-1h1.072a5.992 5.992 0 0 1 .622-1.338L4.338 0a1 1 0 0 1 1.415 1.415l-.725.725a5.992 5.992 0 0 1 1.338.622V8a1 1 0 0 1 1 1z" />
                            </svg>
                        </span>
                        <span class="nav-link-title">
                            {{ trans('main.settings') }}
