                                ...
                                <div class=" row">
                                    <div class="mb-5 col-12">
                                        <label for="description_en"
                                            ...
                                            ({{ trans('main.en') }}) </label>
                                        <textarea id="text_area_1" name="description_en" class="form-control" autocomplete="off">{{ $courseCategory->description_en }}</textarea>
                                    </div>
                                    <div class="mb-5 col-12">
                                        <label for="description_ar"
                                            class="form-label required">{{ trans('main.description') }}
                                            ({{ trans('main.ar') }}) </label>
                                        <textarea id="text_area_2" name="description_ar" class="form-control" autocomplete="off">{{ $courseCategory->description_ar }}</textarea>
                                    </div>
                                </div>
                                <div class=" row mb-4 ">
                                    <div class="mb-3 col">
                                        <label for="price"
                                            class="form-label required col-6">{{ trans('main.price') }}</label>
                                        <input type="number" step=".01" name="price" class="form-control"
                                            autocomplete="off" value="{{ $courseCategory->price }}" />
                                    </div>
