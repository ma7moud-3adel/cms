                                ...
                                <div class="col-10">
                                    ...
                                    <div class=" row">
                                        <div class="mb-3 col">
                                            ...
                                            <input value="{{ $product->name_en }}" type="text" class="form-control"
                                        ...
                                        <div class="mb-3 col">
                                            ...
                                            <input type="text" value="{{ $product->name_ar }}" class="form-control"
                                    ...
                                    <div class=" row">
                                        <div class="mb-5 col-12">
                                            <label for="description_en"
                                                ...
                                                ({{ trans('main.en') }}) </label>
                                            <textarea id="text_area_1" name="description_en" class="form-control" autocomplete="off">{{ $product->description_en }}</textarea>
                                        </div>
                                        <div class="mb-5 col-12">
                                            <label for="description_ar"
                                                class="form-label required">{{ trans('main.description') }}
                                                ({{ trans('main.ar') }}) </label>
                                            <textarea id="text_area_2" name="description_ar" class="form-control" autocomplete="off">{{ $product->description_ar }}</textarea>
                                        </div>
                                    </div>
                                    <div class=" row">
                                        <div class="mb-3 col ">
                                            ...
                                            <select id="select-product-category" name="product_category_id"
                                                ...
                                                @foreach ($productCategories as $productCategory)
                                                    <option value="{{ $productCategory->id }}">
                                                        {{ $productCategory->name_en }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="mb-3 col ">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col ">
                                            <label for="photo"
                                                class="form-label required">{{ trans('main.photo') }}</label>
                                            <input name="photo" type="file" class="image form-control" />
                                        </div>
                                        <div class="col">
                                            <label for="photos"
                                    ...
                                    {{--                                <div class="mb-3  col"> --}}
                                    {{--                                    <img src="{{asset('storage/'.$product->photo)}}" height="130px" width="200px" alt="{{$product->photo}}"> --}}
                                    {{--                                </div> --}}
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingOne">
                                                <button class="accordion-button fw-bold collapsed text-black rounded"
                                                    style="background-color: #f6f8fb" type="button"
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <div class="row">
                                                        <div class="mb-3 col">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="meta_title_en" autocomplete="off" />
                                                        </div>
                                                        <div class="mb-3 col">
                                                            <label for="meta_title_ar" class="form-label required">Meta
                                                                ...
                                                                (AR)</label>
                                                            <input type="text" class="form-control"
                                                                name="meta_title_ar" autocomplete="off" />
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="mb-3 col">
                                                            <label for="meta_desc_en" class="form-label required">Meta
                                                                Desc
                                                                (EN)</label>
                                                            <textarea type="text" class="form-control" name="meta_desc_en" autocomplete="off"></textarea>
                                                        </div>
                                                        <div class="mb-3 col">
                                                            <label for="meta_desc_ar" class="form-label required">Meta
                                                                Desc
                                                                (AR)</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="mb-3 col">
                                                            <label for="keywords"
                                                                class="form-label required">Keywords</label>
