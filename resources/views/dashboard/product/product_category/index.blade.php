            ...
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <div class="card card-md">
                        <div class="card-header">
                            <h3 class="card-title"> {{ trans('main.add_product_category') }}</h3>
                        </div>
                ...
                <div class="col-12">
                    <div class="card card-md  mt-2">
                        <div class="card-header">
                            <h3 class="card-title">{{ trans('main.all_product_categories') }}</h3>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#product-category-table').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ route('product-category.index-datatable') }}",
                    "type": "GET"
                },
                "columns": [{
                        data: 'id',
