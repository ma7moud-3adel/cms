                        ...
                        <form method="POST" action="{{ route('slider.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-10">
                                        <h3 class="h1">{{ trans('main.add_slider') }}</h3>
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="markdown text-secondary col-12 mt-3">
                                                ...
                                                <textarea id="text_area_2" name="description_ar" class="form-control" placeholder="ادخل وصف الصورة" autocomplete="off">{{ old('description_ar') }}</textarea>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="markdown text-secondary col">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ trans('main.slider_table') }}</h3>
                        </div>
                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable text-center"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ trans('main.slider_title_en') }}</th>
                                        <th>{{ trans('main.slider_title_ar') }}</th>
                                        <th>{{ trans('main.slider_img_en') }}</th>
                                        <th>{{ trans('main.slider_img_ar') }}</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {{-- @foreach ($sliders as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->title_en }}</td>
                                            <td>{{ $item->title_ar }}</td>
                                            <td><img width="40" src="{{ asset('storage/' . $item->image_en) }}"></td>
                                            <td><img width="40" src="{{ asset('storage/' . $item->image_ar) }}"></td>
                                            <td class="text-end">
