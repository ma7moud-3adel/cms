...
@section('content')
    <div class="page-body">
        <div class="container-xl">
            @include('dashboard.shared.clientCategory.client_nav')
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <div class="card card-md">
                        ...
                        <form method="POST" action="{{ route('clientCategory.store') }}">
                            @csrf
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-10">
                                        <h3 class="h1">{{ trans('main.add_clientCategory') }}</h3>
                                        <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ trans('main.clientCat_table') }}</h3>
                        </div>
                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable text-center"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ trans('main.clientCat_title_en') }}</th>
                                        <th>{{ trans('main.clientCat_title_ar') }}</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a class="btn btn-outline-primary"
                                                    href="{{ route('clientCategory.edit', $item->id) }}"
                                                    role="button">{{ trans('main.Edit') }}</a>

                                                <form action="{{ route('clientCategory.destroy', $item->id) }}"
