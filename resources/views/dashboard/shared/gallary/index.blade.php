...
{{--                                                    placeholder="Enter Name" autocomplete="off" value="{{ old('link') }}"--}}
{{--                                                    required>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
                                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ trans('main.gallaries_table') }}</h3>
                        </div>
...
{{--                                        <th class="w-1">{{ trans('main.No') }}</th>--}}
                                        <th>{{ trans('main.gallary_title') }}</th>
{{--                                        <th>{{ trans('main.gallary_link') }}</th>--}}
                                        <th>{{ trans('main.gallary_img') }}</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
...
{{--                                                @endforeach--}}
                                            ...
                                            <td class="text-end">
                                                <a class="btn btn-outline-primary"
                                                    href="{{ route('gallary.edit', $item->id) }}"
                                                    role="button">{{ trans('main.Edit') }}</a>
                                                <form action="{{ route('gallary.destroy', $item->id) }}" method="POST"
