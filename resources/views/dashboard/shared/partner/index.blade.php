                        ...
                        <form method="POST" action="{{ route('partner.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-10">
                                        <h3 class="h1">{{ trans('main.add_partner') }}</h3>
                                        <div class="row mb-3">
                                            <div class="markdown text-secondary col">
                                                <label class="form-label">{{ trans('main.partner_img') }}</label>
                                                <input type="file" name="photo" class="form-control" autocomplete="off"
                                                    required>
                                            </div>
                                            <div class="markdown text-secondary col">
                                                <label class="form-label">{{ trans('main.partner_name') }}</label>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ trans('main.partner_table') }}</h3>
                        </div>
                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable text-center"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ trans('main.partner_name') }}</th>
                                        <th>{{ trans('main.partner_img') }}</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a class="btn btn-outline-primary"
                                                    href="{{ route('partner.edit', $item->id) }}"
