                        ...
                        <form method="POST" action="{{ route('projects.update', $project->id) }}"
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-10">
                                        <h3 class="h1">{{ trans('main.edit_project') }}</h3>
                                        <div class="row">
                                            <div class="markdown text-secondary col">
                                                <label class="form-label">{{ trans('main.project_name_en') }}</label>
                                                <input type="text" name="name_en" class="form-control"
                                                    placeholder="Enter Project Name" autocomplete="off"
                                                    value="{{ $project->name_en }}">
                                            </div>
                                            <div class="markdown text-secondary col">
                                                <label class="form-label">{{ trans('main.project_name_ar') }}</label>
                                        ...
                                        <div>
                                            <div class="markdown text-secondary col-12">
                                                <label class="form-label">{{ trans('main.project_desc_en') }}</label>
                                                <textarea id="text_area_1" name="description_en" class="form-control editor" placeholder="Enter Project Description"
                                                    autocomplete="off">{{ $project->description_en }}</textarea>
                                            </div>
                                            <div class="markdown text-secondary col-12">
                                                <label class="form-label">{{ trans('main.project_desc_ar') }}</label>
                                                <textarea id="text_area_2" name="description_ar" class="form-control editor" placeholder="Enter Project Description"
                                                    autocomplete="off">{{ $project->description_ar }}</textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="markdown text-secondary col">
                                                <label class="form-label">{{ trans('main.project_img') }}</label>
                                            ...
                                            <div class="markdown text-secondary col">
                                                <label class="form-label">{{ trans('main.cat_name') }}</label>
                                                <select class="form-control" id="selectGovernment" name="category_id">
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="row mt-5">
                                                                ...
                                                                <div class="markdown text-secondary col">
                                                                    ...
                                                                    <textarea name="meta_description_ar" class="form-control editor" placeholder="ادخل وصف الخبر" autocomplete="off"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="row mt-5">
                                                                <div class="markdown text-secondary col">
                                                            ...
                                                            <div class="row mt-5">
                                                                <div class="markdown text-secondary col">
                                                                    ...
                                                                    <textarea name="slug" class="form-control editor" placeholder="Enter Blog Description" autocomplete="off"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
