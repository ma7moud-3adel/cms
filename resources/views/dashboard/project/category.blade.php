            ...
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <div class="card card-md">
                        ...
                        <form method="POST" action="{{ route('project_categories.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-10">
                                        <h3 class="h1">{{ trans('main.add_project_cat') }}</h3>
                                        <div class="row">
                                        ...
                                        <div>
                                            ...
                                            <div class="markdown text-secondary col-12 mt-3">
                                                ...
                                                <textarea id="text_area_2" name="description_ar" id="" class="form-control"
                                                    placeholder="Enter Category Description" autocomplete="off">{{ old('description_ar') }}</textarea>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ trans('main.caregory_table') }}</h3>
                        </div>
                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable text-center"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ trans('main.project_cat_name_en') }}</th>
                                        <th>{{ trans('main.project_cat_desc_en') }}</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a class="btn btn-outline-primary"
                                                    href="{{ route('project_categories.edit', $item->id) }}"
                                                    role="button">
                                                    {{ trans('main.Edit') }}</a>

                                                <form action="{{ route('project_categories.destroy', $item->id) }}"
    ...
    <script>
        $(document).ready(function() {
            $('#projectCat-table').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ route('projectCat.datatable') }}",
                    "type": "GET"
                },
                "columns": [{
                        data: 'id',
