    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="row row-deck row-cards">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                {{ \Domain\Project\Models\Project::count() }}
                                            </div>
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                {{ \Domain\Product\Models\Product::count() }}
                                            </div>
                                            <div class="text-secondary">
                                                {{ trans('main.product') }}
                                            </div>
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                {{ \Domain\Service\Models\Service::count() }}
                                            </div>
                                            <div class="text-secondary">
                                                {{ trans('main.services') }}
                                            </div>
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                {{ \Domain\Shared\Models\User::count() }}
                                            </div>
                                            <div class="text-secondary">
                                                {{ trans('main.User') }}
                                            </div>
                ...
                <div class="col-6 card h-100 d-flex flex-column ">
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="card">
                        <div class="card-header justify-content-between">
                            <h3 class="card-title">{{ trans('main.products') }}</h3>
                            <a href="{{ route('product.index') }}" class="btn btn-primary">
                                {{ trans('main.go_products') }}
                            </a>
                        </div>
                        <div class="card-table table-responsive">
                            <table class="table table-vcenter">
                                ...
                                <tbody>
                                    ...
                                    @php($products = Domain\Product\Models\Product::latest()->take(4)->get())
                                    @php($id = 1)
                                    @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('storage/' . $product->photo) }}" width="50"
                                                    height="50"></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="card">
                        <div class="card-header justify-content-between">
                            <h3 class="card-title">{{ trans('main.services') }}</h3>
                            <a href="{{ route('service.index') }}" class="btn btn-primary">
                                {{ trans('main.go_services') }}
                            </a>
                        </div>
                        <div class="card-table table-responsive">
                            <table class="table table-vcenter">
                                ...
                                <tbody>
                                    @php($services = Domain\Service\Models\Service::latest()->take(4)->get())
                                    @php($id = 1)
                                    @foreach ($services as $service)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('storage/' . $service->photo) }}" width="50"
                                                    height="50"></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="card">
                        <div class="card-header justify-content-between">
                            <h3 class="card-title">{{ trans('main.projects') }}</h3>
                            <a href="{{ route('projects.index') }}" class="btn btn-primary">
                                {{ trans('main.go_projects') }}
                            </a>
                        </div>
                        <div class="card-table table-responsive">
                            <table class="table table-vcenter">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ trans('main.project_name') }}</th>
                                        <th>{{ trans('main.project_desc') }}</th>
                                        <th>{{ trans('main.project_img') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @php($projects = Domain\Project\Models\Project::latest()->take(4)->get())
                                    @php($id = 1)
                ...
                <div class="col-12">
                    <div class="card card-md">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-10">
                                    <h3 class="h1">{{ trans('main.create_new') }}</h3>
                                    <div class="markdown text-secondary">
                                        {{ trans('main.feature') }}
                                    </div>
                                    <div class="mt-3">
                                        <a href="{{ route('service.create') }}" class="btn btn-primary" target="_blank"
                                            rel="noopener">
                                            ...
                                            <span class="me-2">{{ trans('main.services') }}</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-person-fill-gear" viewBox="0 0 16 16">
                                                <path
                                                    d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0m-9 8c0 1 1 1 1 1h5.256A4.5 4.5 0 0 1 8 12.5a4.5 4.5 0 0 1 1.544-3.393Q8.844 9.002 8 9c-5 0-6 3-6 4m9.886-3.54c.18-.613 1.048-.613 1.229 0l.043.148a.64.64 0 0 0 .921.382l.136-.074c.561-.306 1.175.308.87.869l-.075.136a.64.64 0 0 0 .382.92l.149.045c.612.18.612 1.048 0 1.229l-.15.043a.64.64 0 0 0-.38.921l.074.136c.305.561-.309 1.175-.87.87l-.136-.075a.64.64 0 0 0-.92.382l-.045.149c-.18.612-1.048.612-1.229 0l-.043-.15a.64.64 0 0 0-.921-.38l-.136.074c-.561.305-1.175-.309-.87-.87l.075-.136a.64.64 0 0 0-.382-.92l-.148-.045c-.613-.18-.613-1.048 0-1.229l.148-.043a.64.64 0 0 0 .382-.921l-.074-.136c-.306-.561.308-1.175.869-.87l.136.075a.64.64 0 0 0 .92-.382zM14 12.5a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0" />
                                        ...
                                        <a href="{{ route('product.create') }}" class="btn btn-primary" target="_blank"
                                            rel="noopener">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                                                <path
                                            ...
                                            <span class="me-2">{{ trans('main.products') }}</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-box-seam-fill" viewBox="0 0 16 16">
                                                <path fill-rule="evenodd"
                                                    d="M15.528 2.973a.75.75 0 0 1 .472.696v8.662a.75.75 0 0 1-.472.696l-7.25 2.9a.75.75 0 0 1-.557 0l-7.25-2.9A.75.75 0 0 1 0 12.331V3.669a.75.75 0 0 1 .471-.696L7.443.184l.01-.003.268-.108a.75.75 0 0 1 .558 0l.269.108.01.003zM10.404 2 4.25 4.461 1.846 3.5 1 3.839v.4l6.5 2.6v7.922l.5.2.5-.2V6.84l6.5-2.6v-.4l-.846-.339L8 5.961 5.596 5l6.154-2.461z" />
                                        ...
                                        <a href="{{ route('projects.create') }}" class="btn btn-primary" target="_blank"
                                            rel="noopener">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                                                <path
                                            ...
                                            <span class="me-2">{{ trans('main.projects') }}</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <a href="{{ route('blogs.create') }}" class="btn btn-primary" target="_blank"
                                            rel="noopener">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                                                <path
                                            ...
                                            <span class="me-2">{{ trans('main.Blog') }}</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
@section('libs-js')
    <script src="{{ url('dashboard') }}/libs/apexcharts/dist/apexcharts.min.js?1692870487" defer></script>
    <script src="{{ url('dashboard') }}/libs/jsvectormap/dist/js/jsvectormap.min.js?1692870487" defer></script>
    <script src="{{ url('dashboard') }}/libs/jsvectormap/dist/maps/world.js?1692870487" defer></script>
    <script src="{{ url('dashboard') }}/libs/jsvectormap/dist/maps/world-merc.js?1692870487" defer></script>
@endsection
